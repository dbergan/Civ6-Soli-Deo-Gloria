...
-- Attacking land, sea, air
INSERT OR REPLACE INTO RequirementSets
(RequirementSetId,				RequirementSetType)
VALUES
('DB_REQSET_ATTACKING_LAND',	'REQUIREMENTSET_TEST_ALL'),
('DB_REQSET_ATTACKING_SEA',		'REQUIREMENTSET_TEST_ALL'),
('DB_REQSET_ATTACKING_AIR',		'REQUIREMENTSET_TEST_ALL') ;

INSERT OR REPLACE INTO RequirementSetRequirements
(RequirementSetId,				RequirementId)
VALUES
('DB_REQSET_ATTACKING_LAND',	'DB_REQ_OPPONENT_IS_LAND_UNIT'),
('DB_REQSET_ATTACKING_LAND',	'DB_REQ_ATTACKING'),
('DB_REQSET_ATTACKING_SEA',		'DB_REQ_OPPONENT_IS_SEA_UNIT'),
('DB_REQSET_ATTACKING_SEA',		'DB_REQ_ATTACKING'),
