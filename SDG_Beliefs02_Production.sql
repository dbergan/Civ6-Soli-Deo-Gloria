...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_CHILD_LABOR', 'LOC_SDG_CHILD_LABOR', 'LOC_SDG_CHILD_LABOR_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_CONSIDER_THE_ANT', 'LOC_SDG_CONSIDER_THE_ANT', 'LOC_SDG_CONSIDER_THE_ANT_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_NULLA_DIES_SINE_LINEA', 'LOC_SDG_NULLA_DIES_SINE_LINEA', 'LOC_SDG_NULLA_DIES_SINE_LINEA_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_DESERET', 'LOC_SDG_DESERET', 'LOC_SDG_DESERET_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_PROTESTANT_WORK_ETHIC', 'LOC_SDG_PROTESTANT_WORK_ETHIC', 'LOC_SDG_PROTESTANT_WORK_ETHIC_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
