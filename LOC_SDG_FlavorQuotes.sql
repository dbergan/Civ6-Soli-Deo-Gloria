...
-- 2
('LOC_SDG_FOLLOWER2', 'Soren Kierkegaard', 'en_US'),
('LOC_SDG_FOLLOWER2_DESCRIPTION', 'God does not think, he creates[NEWLINE]God does not exist, he is eternal.', 'en_US'),

('LOC_SDG_FOLLOWER3', '1 John', 'en_US'),
('LOC_SDG_FOLLOWER3_DESCRIPTION', 'God is love, and those who abide in love abide in God, and God abides in them.', 'en_US'),

('LOC_SDG_FOLLOWER4', 'A.W. Tozer', 'en_US'),
('LOC_SDG_FOLLOWER4_DESCRIPTION', 'What comes to mind when we think about God is the most important thing about us.', 'en_US'),

('LOC_SDG_FOLLOWER5', 'Gary Randall', 'en_US'),
('LOC_SDG_FOLLOWER5_DESCRIPTION', 'No matter how bad things are, a person is only one choice away from fixing it all.', 'en_US'),

('LOC_SDG_FOLLOWER6', 'Augustine', 'en_US'),
('LOC_SDG_FOLLOWER6_DESCRIPTION', 'You have made us for yourself, O Lord, and our hearts are restless until they rest in you.', 'en_US'),

('LOC_SDG_FOLLOWER7', 'C.S. Lewis', 'en_US'),
('LOC_SDG_FOLLOWER7_DESCRIPTION', 'I believe in Christianity as I believe that the sun has risen: not only because I see it, but because by it I see everything else.', 'en_US'),

-- 3
('LOC_SDG_FOLLOWER8', 'Dorothy Sayers', 'en_US'),
('LOC_SDG_FOLLOWER8_DESCRIPTION', 'None of us feels the true love of God till we realize how wicked we are. But you can''t teach people that - they have to learn by experience.', 'en_US'),

('LOC_SDG_FOLLOWER9', 'Buddha', 'en_US'),
('LOC_SDG_FOLLOWER9_DESCRIPTION', 'Let a man overcome anger by kindness, evil by good. Victory breeds hatred, for the conquered is unhappy. Never in the world does hatred cease by hatred. Hatred ceases by love.', 'en_US'),

-- 4
('LOC_SDG_FOLLOWER10', 'Kurt Vonnegut', 'en_US'),
('LOC_SDG_FOLLOWER10_DESCRIPTION', 'If I should ever die, God forbid, let this be my epitaph:[NEWLINE]THE ONLY PROOF HE NEEDED[NEWLINE]FOR THE EXISTENCE OF GOD[NEWLINE]WAS MUSIC', 'en_US'),

('LOC_SDG_FOLLOWER11', 'William James', 'en_US'),
('LOC_SDG_FOLLOWER11_DESCRIPTION', 'It makes a tremendous emotional and practical difference to one whether one accepts the universe in the drab discolored way of stoic resignation to necessity, or with the passionate happiness of Christian saints.', 'en_US'),

-- 5
('LOC_SDG_FOLLOWER12', 'C.S. Lewis', 'en_US'),
('LOC_SDG_FOLLOWER12_DESCRIPTION', '"I wish I had never been born," she said.  "What are we born for?"[NEWLINE][NEWLINE]"For infinite happiness," said the Spirit.  "You can step out into it at any moment..."', 'en_US'),

('LOC_SDG_FOLLOWER13', 'Mahalia Jackson', 'en_US'),
('LOC_SDG_FOLLOWER13_DESCRIPTION', 'There are some things I may not know[NEWLINE]There are some places I cannot go[NEWLINE]But I am sure of this one thing[NEWLINE]That God is real[NEWLINE]For I can feel Him in my soul', 'en_US'),

('LOC_SDG_FOLLOWER14', 'Will Durant', 'en_US'),
('LOC_SDG_FOLLOWER14_DESCRIPTION', 'That a few simple men should in one generation have invented so powerful and appealing a personality, so lofty an ethic and so inspiring a vision of human brotherhood, would be a miracle far more incredible than any recorded in the Gospels.', 'en_US'),

('LOC_SDG_FOLLOWER15', 'Bob Dylan', 'en_US'),
('LOC_SDG_FOLLOWER15_DESCRIPTION', 'I hear the ancient footsteps like the motion of the sea[NEWLINE]Sometimes I turn, there''s someone there, other times it''s only me[NEWLINE]I am hanging in the balance of the reality of man[NEWLINE]Like every sparrow falling, like every grain of sand', 'en_US'),

('LOC_SDG_FOLLOWER16', 'C.S. Lewis', 'en_US'),
('LOC_SDG_FOLLOWER16_DESCRIPTION', 'We want, in fact, not so much a Father in Heaven as a grandfather in heaven - a senile benevolence who, as they say, ''liked to see young people enjoying themselves'' and whose plan for the universe was simply that it might be truly said at the end of each day, ''a good time was had by all''.', 'en_US'),

-- 6
('LOC_SDG_FOLLOWER17', 'Buddha', 'en_US'),
('LOC_SDG_FOLLOWER17_DESCRIPTION', 'There is nothing stranger in the history of religion than the sight of Buddha founding a worldwide religion, and yet refusing to be drawn into any discussion about eternity, immortality, or God.[NEWLINE][NEWLINE]-- Our Oriental Heritage by Will Durant (pg 431)', 'en_US'),

('LOC_SDG_FOLLOWER18', 'Albert Einstein', 'en_US'),
('LOC_SDG_FOLLOWER18_DESCRIPTION', 'Try and penetrate with our limited means the secrets of nature and you will find that, behind all the discernible concatenations, there remains something subtle, intangible and inexplicable. Veneration for this force beyond anything that we can comprehend is my religion. To that extent I am, in point of fact, religious.', 'en_US'),

-- 7
('LOC_SDG_FOLLOWER19', 'Will Durant', 'en_US'),
('LOC_SDG_FOLLOWER19_DESCRIPTION', 'Love one another. My final lesson of history is the same as that of Jesus.[NEWLINE][NEWLINE]You may think that''s a lot of lollipop but just try it. Love is the most practical thing in the world. If you take an attitude of love toward everybody you meet, you''ll eventually get along.', 'en_US'),

('LOC_SDG_FOLLOWER20', 'Johann Wolfgang von Goethe', 'en_US'),
('LOC_SDG_FOLLOWER20_DESCRIPTION', 'No matter how far our spiritual culture may continue to progress, no matter how much the natural sciences may grow, becoming ever more profound and more inclusive, no matter how much the human spirit may will to expand, that human spirit will never escape from the majesty and ethical sublimity of Christianity, as it shimmers and shines in the Gospels.', 'en_US'),

('LOC_SDG_FOLLOWER21', 'J.B.S. Haldane', 'en_US'),
...
('LOC_SDG_FOLLOWER22_DESCRIPTION', 'I think that yesterday was a crisis in my life. I finished the first part of Renouvier''s second Essais and see no reason why his definition of free will - "the sustaining of a thought because I choose to when I might have other thoughts" - need be the definition of an illusion. At any rate, I will assume for the present - until next year - that it is no illusion. My first act of free will shall be to believe in free will.', 'en_US'),

-- 8
('LOC_SDG_FOLLOWER23', 'Blaise Pascal', 'en_US'),
('LOC_SDG_FOLLOWER23_DESCRIPTION', 'All of our visible world is but an imperceptible speck in the great bosom of nature. No thought can go so far, it is an infinite sphere whose center is everywhere, and whose circumference is nowhere. This is the most perceivable feature of the almightiness of God, so that our imagination loses itself in this thought.[NEWLINE][NEWLINE]The eternal silence of these infinite spaces frightens me.', 'en_US'),

('LOC_SDG_FOLLOWER24', 'George MacDonald', 'en_US'),
...
-- 19
('LOC_SDG_FOLLOWER34', 'Charles Eastman (Ohiyesa)', 'en_US'),
