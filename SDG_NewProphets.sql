...
INSERT INTO Types (Type, Kind)
  WITH counter as (SELECT 11 x UNION SELECT x + 1 FROM counter WHERE x < 30) 
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES 
                    ("SDG_BLANK_PANTHEON11", "LOC_SDG_BLANK_PANTHEON", "LOC_SDG_BLANK_PANTHEON_DESCRIPTION", "BELIEF_CLASS_PANTHEON") ;

INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType)
  WITH counter as (SELECT 12 x UNION SELECT x + 1 FROM counter WHERE x < 30) 
...
INSERT INTO GreatPersonIndividuals 
  ...
  ('SDG_GREAT_PERSON_INDIVIDUAL_PARSHVANATHA', 'LOC_SDG_GREAT_PERSON_INDIVIDUAL_PARSHVANATHA', 'GREAT_PERSON_CLASS_PROPHET', 'ERA_CLASSICAL', 'M', 0, 1, 1),
  ...
  ('SDG_GREAT_PERSON_INDIVIDUAL_ORIGEN', 'LOC_SDG_GREAT_PERSON_INDIVIDUAL_ORIGEN', 'GREAT_PERSON_CLASS_PROPHET', 'ERA_MEDIEVAL', 'M', 0, 1, 1),
