...
('LOC_PEDIA_CONCEPTS_PAGE_FAITH_5_CHAPTER_CONTENT_PARA_2', 
  'You can then use subsequent[ICON_GreatProphet]Great Prophets to add additional beliefs to your Religion.', 
    'en_US'),
...
('LOC_BUILDING_TEMPLE_DESCRIPTION', 
  'Allows the purchasing of Apostles, Gurus, Inquisitors, and Warrior Monks. These units can only be purchased with [ICON_Faith] Faith.', 
    'en_US'),
...
('LOC_UNIT_GREAT_PROPHET_DESCRIPTION', 
  'A Great[ICON_GreatProphet]Prophet is required to found a Religion.  Subsequent Great Prophets can be used to add more Religious Beliefs. Visit the Great People panel to learn more, and track your progress.', 
    'en_US'),
...
('LOC_RELIGIONPANEL_NEXT_STEP_EVANGELIZE_BELIEF', 
  'Earn another Great Prophet to add another Belief.', 
    'en_US'),
('LOC_UI_RELIGION_LOCKED_BELIEF_DESCRIPTION', 
  'Use a Great Prophet to add a new belief.', 
    'en_US'),
...
('LOC_BUILDING_SDG_PAMPHLET_SHOP_DESCRIPTION', 
  'From the Soli Deo Gloria mod: Acquired for free when you research Printing.  Doesn''t do anything, just allows the "Scripture" and "95 Theses" beliefs to detect when a city has Printing.', 
    'en_US'),
...
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_FOOD_BELIEFS_NAME', '3 - Food & Growth Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_PRODUCTION_BELIEFS_NAME', '4 - Production Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_MILITARY_BELIEFS_NAME', ' 1 - Military Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_SCIENCE_BELIEFS_NAME', '6 - Science Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_CULTURE_BELIEFS_NAME', '7 - Culture Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_AMENITIES_BELIEFS_NAME', '12 - Amenity Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_HOUSING_BELIEFS_NAME', '11 - Housing Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_GOLD_BELIEFS_NAME', '5 - Gold Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_RELIGION_BELIEFS_NAME', '8 - Faith & Religion Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_CITY_BELIEFS_NAME', '13 - Harvest Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_RESOURCES_BELIEFS_NAME', '15 - Resource Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_WONDERS_BELIEFS_NAME', '14 - Wonder Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_NAVAL_BELIEFS_NAME', '2 - Naval Beliefs', 'en_US'),
('LOC_SDG_PEDIA_RELIGIONS_PAGEGROUP_MUSES_BELIEFS_NAME', '10 - Great People Beliefs', 'en_US'),
