...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_MONUMENT_TO_THE_GODS', 'LOC_SDG_MONUMENT_TO_THE_GODS', 'LOC_SDG_MONUMENT_TO_THE_GODS_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_MONUMENT_TO_THE_GODS2', 'LOC_SDG_MONUMENT_TO_THE_GODS2', 'LOC_SDG_MONUMENT_TO_THE_GODS2_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
INSERT INTO BeliefModifiers (BeliefType, ModifierID) 
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_MONUMENT_TO_THE_GODS3', 'LOC_SDG_MONUMENT_TO_THE_GODS3', 'LOC_SDG_MONUMENT_TO_THE_GODS3_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
INSERT INTO BeliefModifiers (BeliefType, ModifierID) 
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_MONUMENT_TO_THE_GODS4', 'LOC_SDG_MONUMENT_TO_THE_GODS4', 'LOC_SDG_MONUMENT_TO_THE_GODS4_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
INSERT INTO BeliefModifiers (BeliefType, ModifierID) 
...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) VALUES ('SDG_MONUMENT_TO_THE_GODS5', 'LOC_SDG_MONUMENT_TO_THE_GODS5', 'LOC_SDG_MONUMENT_TO_THE_GODS5_DESCRIPTION', 'SDG_BELIEF_CLASS_199') ;
UPDATE Beliefs SET BeliefClassType = 'SDG_BELIEF_CLASS_' || (SELECT cast(COUNT(BeliefType) + 9 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') WHERE BeliefClassType = 'SDG_BELIEF_CLASS_199' ;
INSERT INTO BeliefModifiers (BeliefType, ModifierID) 
