...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_MELPOMENE', 'LOC_SDG_MELPOMENE', 'LOC_SDG_MELPOMENE_DESCRIPTION', 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_MELPOMENE_GPP', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_MELPOMENE_GPP', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_GENERAL'),
							  ('SDG_MELPOMENE_GPP', 'Amount', 1) ;
...
INSERT INTO BeliefClasses (BeliefClassType, Name, MaxInReligion, AdoptionOrder)
	SELECT 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%'), 'LOC_SDG_BELIEF_CLASS_MUSES_NAME', 999, (SELECT COUNT(BeliefType) + 100 FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_CLIO', 'LOC_SDG_CLIO', 'LOC_SDG_CLIO_DESCRIPTION', 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_CLIO_GPP', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_CLIO_GPP', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_SCIENTIST'),
							  ('SDG_CLIO_GPP', 'Amount', 1) ;
...
INSERT INTO BeliefClasses (BeliefClassType, Name, MaxInReligion, AdoptionOrder)
	SELECT 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%'), 'LOC_SDG_BELIEF_CLASS_MUSES_NAME', 999, (SELECT COUNT(BeliefType) + 100 FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_CALLIOPE_TERPSICHORE_EUTERPE', 'LOC_SDG_CALLIOPE_TERPSICHORE_EUTERPE', 'LOC_SDG_CALLIOPE_TERPSICHORE_EUTERPE_DESCRIPTION', 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATWRITER', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATWRITER', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_WRITER'),
							  ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATWRITER', 'Amount', 1) ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATARTIST', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATARTIST', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ARTIST'),
							  ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATARTIST', 'Amount', 1) ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATMUSICIAN', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATMUSICIAN', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_MUSICIAN'),
							  ('SDG_CALLIOPE_TERPSICHORE_EUTERPE_GREATMUSICIAN', 'Amount', 1) ;
...
INSERT INTO BeliefClasses (BeliefClassType, Name, MaxInReligion, AdoptionOrder)
	SELECT 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%'), 'LOC_SDG_BELIEF_CLASS_MUSES_NAME', 999, (SELECT COUNT(BeliefType) + 100 FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_THALIA', 'LOC_SDG_THALIA', 'LOC_SDG_THALIA_DESCRIPTION', 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_THALIA_GPP', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_THALIA_GPP', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_MERCHANT'),
							  ('SDG_THALIA_GPP', 'Amount', 1) ;
...
INSERT INTO BeliefClasses (BeliefClassType, Name, MaxInReligion, AdoptionOrder)
	SELECT 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%'), 'LOC_SDG_BELIEF_CLASS_MUSES_NAME', 999, (SELECT COUNT(BeliefType) + 100 FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_ERATO', 'LOC_SDG_ERATO', 'LOC_SDG_ERATO_DESCRIPTION', 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_ERATO_GPP', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_ERATO_GPP', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ENGINEER'),
							  ('SDG_ERATO_GPP', 'Amount', 1) ;
...
INSERT INTO BeliefClasses (BeliefClassType, Name, MaxInReligion, AdoptionOrder)
	SELECT 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%'), 'LOC_SDG_BELIEF_CLASS_MUSES_NAME', 999, (SELECT COUNT(BeliefType) + 100 FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_URANIA', 'LOC_SDG_URANIA', 'LOC_SDG_URANIA_DESCRIPTION', 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('SDG_URANIA_GPP', 'DB_DM_ADJUST_DISTRICT_GREATPERSON', 'DB_REQSET_IS_CITY_CENTER') ;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
							  ('SDG_URANIA_GPP', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ADMIRAL'),
							  ('SDG_URANIA_GPP', 'Amount', 1) ;
...
INSERT INTO BeliefClasses (BeliefClassType, Name, MaxInReligion, AdoptionOrder)
	SELECT 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%'), 'LOC_SDG_BELIEF_CLASS_MUSES_NAME', 999, (SELECT COUNT(BeliefType) + 100 FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_POLYHYMNIA', 'LOC_SDG_POLYHYMNIA', 'LOC_SDG_POLYHYMNIA_DESCRIPTION', 'SDG_BELIEF_CLASS_MUSES_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
