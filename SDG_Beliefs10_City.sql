...
INSERT INTO Beliefs (BeliefType, Name, Description, BeliefClassType) 
	SELECT 'SDG_OKTOBERFEST', 'LOC_SDG_OKTOBERFEST', 'LOC_SDG_OKTOBERFEST_DESCRIPTION', 'SDG_BELIEF_CLASS_CITY_' || (SELECT cast(COUNT(BeliefType) + 100 as text) FROM Beliefs WHERE BeliefClassType LIKE 'SDG_BELIEF_CLASS_%') ;
